...
*** Gruvbox theme
    ...
    #+begin_src emacs-lisp
      ...
      ;; :config (add-to-list 'qk/themes-list 'gruvbox-dark-medium))
    #+end_src
       ...
       (transient-define-prefix qk/org-agenda-transient ()
         ...
         [
          ...
          ["Show"
           ...
           ("s q" "Show qkessler calendar" qk/open-qkessler-gcal)
           ("s e" "Show enrique.kesslerm calendar" qk/open-ekm-gcal)
           ]
          ["View"
       ...
       (use-package calfw
         ...
         (with-eval-after-load 'calfw
           (use-package calfw-ical
             :straight (:host github :repo "Qkessler/emacs-calfw"))
    ...
    #+begin_src emacs-lisp
      (use-package circe
        ...
        (defun qk/lpass-fetch-libera-password (server)
          "Returns Libera's NickServer password"
