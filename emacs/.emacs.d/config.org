...
***** Consult-projectile
      ...
      #+begin_src emacs-lisp
        (use-package consult-projectile
          ...
          :config (setq consult-projectile-preview-key (kbd "M-.")))
      #+end_src
...
**** org-agenda hydra
     ...
     #+begin_src emacs-lisp
       (transient-define-prefix qk/org-agenda-transient ()
         ...
         [
          ["Entry"
           ("h A" "Archive default" org-agenda-archive-default)
           ("h k" "Remove entry" org-agenda-kill)
           ("h r" "Refile" org-agenda-refile)
           ("h p" "Set priority" org-agenda-priority)
           ("h :" "Set tags" org-agenda-set-tags)
           ("h t" "Set state" org-agenda-todo)
           ("d d" "Set deadline" org-agenda-deadline)
           ("d t" "Date prompt" org-agenda-date-prompt)
           ("d s" "Schedule" org-agenda-schedule)
           ("+" "Next day" org-agenda-do-date-later)
           ("-" "Previous day" org-agenda-do-date-earlier)
     ...
     #+BEGIN_SRC emacs-lisp
       (add-hook 'org-agenda-mode-hook
                 (lambda ()
                   ...
                   (local-set-key (kbd "?") 'qk/org-agenda-transient)))
     #+END_SRC
